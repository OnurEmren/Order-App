...
import com.onuremren.googleyemekapp.databinding.FragmentCheckoutBinding
...
class CheckoutFragment : Fragment() {
    ...
    fun cancelOrder() {
        ...
        findNavController().navigate(R.id.action_checkoutFragment_to_accompanimentMenuFragment)
    }
